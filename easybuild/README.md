...
## Elementary Example ([Introductory](./0_Introductory))

This directory contains an elementary example for users to get started on building/rebuilding their own software.

## Advanced Topics ([Advanced](./1_Advanced))

Coming Soon

## Application Specific ([Application Specific](2_ApplicationSpecific))

This directory contains examples used to build specific applications like Orca, Gaussian, etc. with EasyBuild. A [table of available examples](./2_ApplicationSpecific/README.md#table-of-topics) is provided for easier navigation and reference.
